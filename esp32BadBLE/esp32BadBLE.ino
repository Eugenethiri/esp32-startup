...
// Set up web server and bluetooth identity (device name; type of device; charge level)
WebServer server(80);
BleKeyboard bleKeyboard("Hello Kitty<3", "Keyboard", 47);
...
void setup() {
  ...
  WiFi.softAP("BadBLE", "YouShallNotPass");
